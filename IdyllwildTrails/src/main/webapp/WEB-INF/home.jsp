						...
						<c:forEach items="${trail}" var="trail">
							<tr>
								<td><a class="text-decoration-none"
									href="display.do?id=${trail.id }">${trail.name} Trail</a></td>
								<td><a class="text-decoration-none"
									href="display.do?id=${trail.id }">${trail.distance} miles</a></td>
								<td><a class="text-decoration-none"
									href="display.do?id=${trail.id }">${trail.maxElevation} ft</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
