...
<body>
	...
	<form action="addTrail.do" method="POST">
		...
		<input type="number" name="elevationGain"> <br> 
		<label for="elevation_loss">Elevation loss </label> 
		<input type="number" name="elevationLoss"> <br> 
		<label for="dog_friendly">Dog Friendly </label> 
		<input type="checkbox" name="dogFriendly"> <br> 
		<label for="permit_req">Permit Required </label> 
		<input type="checkbox" name="needPermit"> <br> 
		<label for="trail_head_latitude">Trail Head Latitude </label> 
		<input type=number name="headLat"> <br> 
		<label for="trail_head_longitude">Trail Head Longitude</label> 
		<input type="number" name="headLong"> <br> 
		
		
		
		<input type="submit" value="Add New Trail" />
	</form>
